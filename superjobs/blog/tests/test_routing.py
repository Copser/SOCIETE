...
def test_jobs_resolvers_to_jobs_view():
...
def test_post_resolvers_to_post_view():
...
def test_post_list_resolvers_to_post_list_api_view():
...
def test_post_detail_resolvers_to_post_deatail_api_view():
...
def test_apply_to_resolvers_to_apply_to_view():
...
def test_success_to_resolve_to_success_url_views():
...
def test_return_appropriate_post_page_status_code():
    """TODO: test post page status code
    return: TODO
    """
    post_page_status_code = client.get('/blog/post/')
    assert post_page_status_code.status_code == 404

def test_return_appropriate_jobs_page_status_code():
    """TODO: test jobs page status code
    return: TODO
    """
    jobs_page_status_code = client.get('/blog/jobs/')
    assert jobs_page_status_code.status_code == 200

def test_posts_list_api_return_proper_status_code():
    """TODO: test posts_list api status code, should return 200
    status_code if page exists
    return: TODO
    """
    posts_lists_status_code = client.get('/blog/posts/')
    assert posts_lists_status_code.status_code == 200

def test_apply_to_return_proper_status_code():
    """TODO: test apply_to status code return 200
    return: TODO
    """
    apply_to_status_code = client.get('/blog/apply_to/')
    assert apply_to_status_code.status_code == 200

def test_success_return_proper_status_code():
    """TODO: test success status code return 200
    return: TODO
    """
    success_status_code = client.get('/blog/success/')
